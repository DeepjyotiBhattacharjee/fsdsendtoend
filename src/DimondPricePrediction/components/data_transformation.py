...
class DataTransformation:
    ...
    def get_data_transformation(self):
        try:
            ...
            # Define which columns should be scaled and which should be ordinally encoded
    ...
    steps=[
         ...
         ('orinalencoder',OrdinalEncoder(categories=[cut_categories,color_categories,clarity_categories]))
    ]
)
            # Transformation
